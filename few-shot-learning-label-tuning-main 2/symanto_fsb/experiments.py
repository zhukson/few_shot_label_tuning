...
from labels import to_hypothesis
...
def test_model(
    ...
    # TODO: 把测试后的predictions，对test text标注，然后再次训练
    # 测试完后，把数据放进去进行二次训练
    # soft label转成hypothesis
    # soft_hypotheses = {
    #     label: to_hypothesis(predictions, dataset, config) for label in labels.names
    # }
